...
/***/ function(module, exports, __webpack_require__) {
	...
	function createComponent(name) {
	    var _MyNode = function (_React$Component) {
	        _inherits(_MyNode, _React$Component);

	        function _MyNode(props) {
	            _classCallCheck(this, _MyNode);

	            var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(_MyNode).call(this, props));

	            console.log(name + ' is created.');
	            return _this;
	        }

	        _createClass(_MyNode, [{
	            ...
	            value: function render() {
	                return React.createElement(
	                    'div',
	                    { className: 'node ' + name, 'data-name': name },
	                    this.props.children
	                );
	            }
	        }]);
	    ...
	    shape5: function shape5() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(C, { key: 'C' })
	            )
	        );
	    },

	    shape6: function shape6() {
	        return React.createElement(
	            Root,
	            null,
	            React.createElement(
	...
	window.render = function render(shape) {
	    ReactDOM.render(React.createElement(Wrapper, { shape: shape }), document.getElementById('react-root'), function () {
	        console.log('=====================');
	    });
	};
