	...
	var Header = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            'div',
	            { style: { width: '100%', height: '48px', lineHeight: '48px', textAlign: 'center' } },
	            this.props.title
	        );
	    }
	});

	var Lifecycle = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            'div',
	            null,
	            this.state.title != '' && _react2.default.createElement(Header, { title: this.state.title }),
	            _react2.default.createElement(
	                'div',
	                { className: 'body' },
	                _react2.default.createElement('input', { type: 'text', placeholder: '修改标题', ref: 'myInput' }),
	                _react2.default.createElement('input', { type: 'button', onClick: this.handleTap, value: 'update' })
	            )
	        );
	    }
	});

	(0, _reactDom.render)(_react2.default.createElement(Lifecycle, null), document.getElementById("app"));
