...
/***/ function(module, exports, __webpack_require__) {
	...
	//}
	var HelloDemo = _react2.default.createClass({
	    ...
	    getInitialState: function getInitialState() {
	        return {
	            list: [{ name: '张三' }, { name: '李四' }, { name: '王五' }, { name: '赵六' }]
	        };
	    },
	    handleTap: function handleTap() {
	        var that = this;
	        var name = that.refs.myInput.value;
	        if (name.length > 0) {
	            var s = that.state.list;
	            s.push({ name: name });
	            that.setState({ list: s }, function () {
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'div',
	                { style: { width: '200px', height: '60px', border: '1px solid red', borderRadius: '5px', padding: '35px 0 0 15px' } },
	                _react2.default.createElement('input', { type: 'text', ref: 'myInput' }),
	                _react2.default.createElement('input', { type: 'button', onClick: this.handleTap, value: 'Add' })
	            ),
	            _react2.default.createElement(
	                'div',
	                null,
	...
	_reactDom2.default.render(_react2.default.createElement(HelloDemo, { name: "React" }), document.getElementById("app"));
